        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-3xl">
              <span className='text-[#0C71C3] '>Teléfono:</span> <span className=''>+52 442 642 3149</span><br />
              <span className='text-[#0C71C3] '>Movil:</span> <span className=''>+52 442-561-9371</span><br />
              <span className='text-[#0C71C3] '>Email:</span> <span className=''>info@endomedicsqro.com</span><br />
              <span className='text-[#0C71C3] '>Dirección:</span> <span className=''>Calle Principal #123, Ciudad</span>
            </p>
          </div>
          <div>
