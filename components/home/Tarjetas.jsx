    ...
    return (
        <div className=''>
            <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-x-3 gap-y-4 lg:gap-y-0 text-white mt-8 justify-items-center'>
                <div className='text-justify rounded-md shadow-md p-4 bg-[#0C71C3] w-full h-[400px] sm:h-[300px] lg:h-[400px]'>
                ...
                <div className='text-justify rounded-md shadow-md p-4 bg-[#0C71C3] w-full h-[400px] sm:h-[300px] lg:h-[400px] w-full'>
                    <div className='flex justify-center mb-2'>
                        <img
                            src="/home/venas.png"
                            alt="Imagen 1"
                    ...
                    <div>
                        <ul className='list-disc pl-2'>
                            <li>
                                Ligasure LS10 sistema de sellador de vasos por RF. (ultima generacion)
                            </li>
                            <li>
                                Sonicision Dissector ultrasonico (inalambrico)
                            </li>
                            <li>
